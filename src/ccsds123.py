...
class CCSDS123():
    ...
    def save_data(self):
        ...
        np.savetxt(self.output_folder + "/" + "00-local_sum.csv", self.local_sum.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "01-local_difference_vector.csv", self.local_difference_vector.reshape(csv_vector_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "02-weight_vector.csv", self.weight_vector.reshape(csv_vector_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "03-predicted_central_local_difference.csv", self.predicted_central_local_difference.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "04-high_resolution_predicted_sample_value.csv", self.high_resolution_predicted_sample_value.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "05-double_resolution_predicted_sample_value.csv", self.double_resolution_predicted_sample_value.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "06-predicted_sample_value.csv", self.predicted_sample_value.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "07-prediction_residual.csv", self.prediction_residual.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "08-maximum_error.csv", self.maximum_error.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "09-quantizer_index.csv", self.quantizer_index.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "10-clipped_quantizer_bin_center.csv", self.clipped_quantizer_bin_center.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "11-double_resolution_sample_representative.csv", self.double_resolution_sample_representative.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "12-sample_representative.csv", self.sample_representative.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "13-double_resolution_prediction_error.csv", self.double_resolution_prediction_error.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "14-mapped_quantizer_index.csv", self.mapped_quantizer_index.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "15-spectral_bands_used.csv", self.spectral_bands_used, delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "16-image_sample.csv", self.image_sample.reshape(csv_image_shape), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "17-weight_update_scaling_exponent.csv", self.weight_update_scaling_exponent.reshape((self.header.y_size, self.header.x_size)), delimiter=",", fmt='%d')
        np.savetxt(self.output_folder + "/" + "18-scaled_prediction_endpoint_difference.csv", self.scaled_prediction_endpoint_difference.reshape(csv_image_shape), delimiter=",", fmt='%d')
